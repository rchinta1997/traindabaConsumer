...
const Login = () => {
        ...
        .then((response) => {
          ...
          if (response.data) {
            toast.current.show({
              severity: "success",
              summary: "Success",
              detail: "New password has sent to your registered email address.",
              life: 3000,
            });
            setTimeout(() => {
              setIsForgotPassword(false);
          ...
          if (response.data.success) {
            ...
            if (context?.cart?.length > 0) {
              ...
              if (passengerData) {
                ...
                passengerInfo["mobileNumber"] =
                  response.data.body?.mobileNumber;
  ...
  const handleSignupSubmit = (e) => {
    ...
    if (checkValidation()) {
      ...
      console.log(
        "=====submitForm============" + process.env.REACT_APP_BASE_URL
      );
      let user = {
        emailID: formData.email,
  ...
  const checkValidation = () => {
    ...
    if (
      formData.mobile &&
      !indianMobileNumberRegex.test(formData.mobile) &&
      !isLoginPage
    ) {
    ...
    if (
      ...
      newErrors.password =
        "Password must be at least 8 characters long, one upper case letter, one lower case letter, one numerical digit and one special character";
    }
                      ...
                      <Form className="form" onSubmit={handleLoginSubmit}>
                        ...
                        <FormGroup>
                          <li>
                            ...
                            />
                            <i
                              className="login-box-iconin far fa-eye"
                    ...
                    <ul className="login_row">
                      <Form className="form" onSubmit={handleSignupSubmit}>
                        ...
                        <FormGroup>
                          ...
                          <FormFeedback>
                            Uh oh! Looks like there is an issue with your mobile
                            number. Please input a correct mobile number.
                          </FormFeedback>
                        </FormGroup>
                        <FormGroup>
                          <li>
                      ...
                      <ul>
                        <li>
                          <Input
                            ...
                            required=""
                          />{" "}
                          <i className="login-box-iconin email far fa-envelope"></i>
                        </li>
                        <span className="error">{validEmailMsg}</span>
                        <div className="forgot-pass">
                          <a
                            href="#"
                            className="ritekhana-header-btn"
                            id="reset_pwd"
