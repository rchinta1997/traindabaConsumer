    ...
    return (
        <>
            ...
            <div className="page-title-section">
                <div className="container"><h2>Confirm & Pay</h2></div>
            </div>
            ...
            <div className="row">
                 ...
                 <div className="row">
                    ...
                    <div className="col-md-12 text-right">
                        <a onClick={payOnline} className="proceed-btn" id="rzp-button1">
                            Proceed to pay Online
                        </a> &nbsp; <a onClick={(event) => clickHandler(event, "Login")} className="proceed-btn" id="cod1">
                            Cash On Delivery
                        </a>
                    </div>
                    </div>
